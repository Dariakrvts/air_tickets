...
import { V as VaSelectOptionList } from "./components/VaSelectOptionList/index-8fe5b5c4.mjs";
import { V as VaSelectContent } from "./components/VaSelectContent/index-d2df7d21.mjs";
import { u as useMaxVisibleOptionsProps, a as useMaxVisibleOptions } from "./hooks/useMaxVisibleOptions-a7eecfbc.mjs";
import { u as useToggleIconProps, a as useToggleIcon } from "./hooks/useToggleIcon-5e8927ed.mjs";
...
import { V as VaDropdownContent } from "../va-dropdown/components/VaDropdownContent/index-0209c7a0.mjs";
import { V as VaInput } from "../va-input/index-a46ef122.mjs";
import { V as VaInputWrapper } from "../va-input/components/VaInputWrapper/VaInputWrapper-911e995d.mjs";
import { u as useMaxSelectionsProps, a as useMaxSelections } from "../../composables/useMaxSelections-84353cfa.mjs";
import { e as extractComponentProps } from "../../utils/component-options/extract-component-options-6b96d215.mjs";
import { V as VaIcon } from "../va-icon/index-7fefcddb.mjs";
import { V as VaDropdown } from "../va-dropdown/index-9e0e771a.mjs";
import { a as useValidationEmits, u as useValidationProps, b as useValidation } from "../../composables/useValidation-a080a9b3.mjs";
...
import { u as useSelectableListProps, a as useSelectableList } from "../../composables/useSelectableList-db4344e1.mjs";
import { u as useLoadingProps } from "../../composables/useLoading-5a447e96.mjs";
import { u as useFormFieldProps } from "../../composables/useFormField-fc3f10c4.mjs";
...
const _sfc_main = defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    const optionsListPropsComputed = computed(() => ({
      ...pick_1(props, ["textBy", "trackBy", "groupBy", "valueBy", "disabledBy", "color", "virtualScroller", "highlightMatchedText", "minSearchChars", "delay", "selectedTopShown"]),
    ...
    const inputWrapperPropsComputed = computed(() => ({
      ...pick_1(props, ["messages", "requiredMark", "bordered", "outline", "label", "color", "success", "readonly", "disabled", "error", "loading"]),
    ...
    const selectContentPropsComputed = computed(() => ({
      ...pick_1(props, ["placeholder", "autocomplete", "multiple", "disabled", "readonly"]),
      tabindex: tabIndexComputed.value,
...
//# sourceMappingURL=VaSelect.vue_vue_type_script_lang-5e7fea78.mjs.map
