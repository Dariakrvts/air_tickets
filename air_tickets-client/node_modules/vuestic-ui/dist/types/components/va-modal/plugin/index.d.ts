...
declare const createVaModalPlugin: (app: App<any>) => {
    init(options: string | Partial<Omit<import("../../../utils/component-options").ExtractComponentPropTypes<import("vue").DefineComponent<{
        modelValue: {
    ...
    }>> & import("../types").ModalEmits, "anchorClass">>): import("vue").VNode<import("vue").RendererNode, import("vue").RendererElement, {
        [key: string]: any;
    }>;
};
