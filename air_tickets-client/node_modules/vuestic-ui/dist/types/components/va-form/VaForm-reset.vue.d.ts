declare const _default: {
    ...
    components: {
        ...
        VaSelect: import("vue").DefineComponent<{
            ...
            optionList: import("vue").ShallowRef<import("vue").DefineComponent<{
                ...
                selectOptionProps: import("vue").ComputedRef<{
                    ...
                    getTrackBy: (option: import("../va-select").SelectOption) => string | number;
                    search: string;
                    color: string;
                ...
                getDisabled: (option: import("../va-select").SelectOption) => boolean;
                selectHoveredOption: () => void;
                handleMouseMove: (option: import("../va-select").SelectOption) => void;
                handleMouseEnter: (option: import("../va-select").SelectOption) => void;
            ...
            getOptionByValue: (value: import("../va-select").SelectOption) => import("../va-select").SelectOption;
            compareOptions: (option1: import("../va-select").SelectOption, option2: import("../va-select").SelectOption) => boolean;
            getText: (option: import("../va-select").SelectOption) => string;
        }, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, string[], string, import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, Readonly<import("vue").ExtractPropTypes<{
            modelValue: {
                type: import("vue").PropType<import("../va-select").SelectOption | import("../va-select").SelectOption[]>;
        ...
        VaOptionList: import("vue").DefineComponent<{
            ...
            getText: (option: import("../va-select").SelectOption) => string;
            getTrackBy: (option: import("../va-select").SelectOption) => string | number;
            isDisabled: (option: import("../va-select").SelectOption) => boolean;
            reset: () => void;
            focus: () => void;
            setItemRef: (el: any) => void;
